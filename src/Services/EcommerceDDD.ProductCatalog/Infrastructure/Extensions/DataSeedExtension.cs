...
public static class DataSeedExtension
{
	...
	/// Uses deterministic IDs for consistent seeding with InventoryManagement.
	/// </summary>
	...
	public static async Task<IApplicationBuilder> SeedProductCatalogAsync(this IApplicationBuilder app)
	{
		...
		try
		{
			...
			if (!hasProducts)
			{
				// Creating products with deterministic IDs
				var products = new List<Product>()
				{
					...
					Product.Create(new ProductData(
						...
						ProductSeedIds.FjallravenBackpack
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.MensCasualTShirt
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.MensCottonJacket
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.MensCasualSlimFit
					),
					...
					Product.Create(new ProductData(
						...
						ProductSeedIds.JohnHardyBracelet
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.SolidGoldMicropave
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.WhiteGoldPrincess
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.PiercedOwlEarrings
					),
					...
					Product.Create(new ProductData(
						...
						ProductSeedIds.WD2TBHardDrive
					),
					Product.Create(new ProductData(
						Name: "SanDisk SSD PLUS 1TB Internal SSD - SATA III 6 Gb/s",
						Category: "electronics",
						Description: "Easy upgrade for faster boot up, shutdown, application load and response (As compared to 5400 RPM SATA 2.5' hard drive; Based on published specifications and internal benchmarking tests using PCMark vantage scores) Boosts burst write performance, making it ideal for typical PC workloads The perfect balance of performance and reliability Read/write speeds of up to 535MBs//450MBs (Based on internal testing; Performance may vary depending upon drive capacity, host device, OS and application.)",
						ImageUrl: "https://fakestoreapi.com/img/61U7T1koQqL._AC_SX679_t.png",
						UnitPrice: Money.Of(109M, Currency.USDollar.Code)),
						ProductSeedIds.SanDiskSSD
					),
					Product.Create(new ProductData(
						...
						UnitPrice: Money.Of(109M, Currency.USDollar.Code)),
						ProductSeedIds.SiliconPowerSSD
					),
					Product.Create(new ProductData(
						...
						UnitPrice: Money.Of(114M, Currency.USDollar.Code)),
						ProductSeedIds.WD4TBGamingDrive
					),
					Product.Create(new ProductData(
						...
						UnitPrice: Money.Of(599M, Currency.USDollar.Code)),
						ProductSeedIds.AcerMonitor
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.SamsungCurvedMonitor
					),
					...
					Product.Create(new ProductData(
						...
						ProductSeedIds.WomensSnowboardJacket
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.WomensFauxLeatherJacket
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.WomensRainJacket
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.WomensBoatNeckTop
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.WomensMoistureTee
					),
					Product.Create(new ProductData(
						...
						ProductSeedIds.WomensCottonTShirt
					)
				};
			...
			{
				Console.WriteLine("No products to seed...");
			}
		}
		catch (Exception ex)
		{
