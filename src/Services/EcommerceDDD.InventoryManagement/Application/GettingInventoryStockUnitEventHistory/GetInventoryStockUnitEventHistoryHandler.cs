...
) : IQueryHandler<GetInventoryStockUnitEventHistory, IReadOnlyList<InventoryStockUnitEventHistory>>
{
	...
	public async Task<Result<IReadOnlyList<InventoryStockUnitEventHistory>>> HandleAsync(GetInventoryStockUnitEventHistory query,
        CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(stockUnitEventStory);
    }
}
