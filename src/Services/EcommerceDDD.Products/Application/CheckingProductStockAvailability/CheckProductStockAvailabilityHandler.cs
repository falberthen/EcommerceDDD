...
public class CheckProductStockAvailabilityHandler : QueryHandler<CheckProductStockAvailability, IList<ProductInStockViewModel>> 
{
    ...
    public override async Task<IList<ProductInStockViewModel>> Handle(CheckProductStockAvailability query, CancellationToken cancellationToken)
    {
