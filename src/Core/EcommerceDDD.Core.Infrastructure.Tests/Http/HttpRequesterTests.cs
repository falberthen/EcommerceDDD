...
public class HttpRequesterTests
{
    ...
    public async Task PostAsync_ShouldReturnResponse()
    {
        // Given        
        SetupMessageHandlerResponse(
            new StringContent(JsonConvert.SerializeObject(new IntegrationServiceResponse() { Success = true }))
        );
        ...
        // When
        var response = await requester.PostAsync<IntegrationServiceResponse>(_url, new object());
    ...
    public async Task PutAsync_ShouldReturnResponse()
    {
        ...
        // When
        var response = await requester.PutAsync<IntegrationServiceResponse>(_url, new object());
    ...
    public async Task DeleteAsync_ShouldReturnResponse()
    {
        ...
        // When
        var response = await requester.DeleteAsync<IntegrationServiceResponse>(_url);
