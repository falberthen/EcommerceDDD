...
using System;
namespace EcommerceDDD.ServiceClients.PaymentProcessing.Api.V2.Internal.Payments.Item.Cancel
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v2\internal\payments\{paymentId}\cancel
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class CancelRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::EcommerceDDD.ServiceClients.PaymentProcessing.Api.V2.Internal.Payments.Item.Cancel.CancelRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v2/internal/payments/{paymentId}/cancel", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::EcommerceDDD.ServiceClients.PaymentProcessing.Api.V2.Internal.Payments.Item.Cancel.CancelRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CancelRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v2/internal/payments/{paymentId}/cancel", rawUrl)
        {
        }
...
#nullable enable
        public async Task<Stream?> PostAsync(global::EcommerceDDD.ServiceClients.PaymentProcessing.Models.CancelPaymentRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PostAsync(global::EcommerceDDD.ServiceClients.PaymentProcessing.Models.CancelPaymentRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::EcommerceDDD.ServiceClients.PaymentProcessing.Models.CancelPaymentRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::EcommerceDDD.ServiceClients.PaymentProcessing.Models.CancelPaymentRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::EcommerceDDD.ServiceClients.PaymentProcessing.Api.V2.Internal.Payments.Item.Cancel.CancelRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::EcommerceDDD.ServiceClients.PaymentProcessing.Api.V2.Internal.Payments.Item.Cancel.CancelRequestBuilder WithUrl(string rawUrl)
        {
            return new global::EcommerceDDD.ServiceClients.PaymentProcessing.Api.V2.Internal.Payments.Item.Cancel.CancelRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
