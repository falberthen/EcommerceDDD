...
using System;
namespace EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.Details
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.Details.DetailsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.Details.DetailsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.Details.DetailsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.Details.DetailsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
