...
#nullable enable
        public async Task<Stream?> PutAsync(global::EcommerceDDD.ServiceClients.CustomerManagement.Models.UpdateCustomerRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PutAsync(global::EcommerceDDD.ServiceClients.CustomerManagement.Models.UpdateCustomerRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
