...
using System;
namespace EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers
{
    /// <summary>
    ...
    public partial class CustomersRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.Details.DetailsRequestBuilder Details
        {
            get => new global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.Details.DetailsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The history property</summary>
        public global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.History.HistoryRequestBuilder History
        {
            get => new global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.History.HistoryRequestBuilder(PathParameters, RequestAdapter);
        }
...
#nullable enable
        public async Task<string?> PostAsync(global::EcommerceDDD.ServiceClients.CustomerManagement.Models.RegisterCustomerRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<string> PostAsync(global::EcommerceDDD.ServiceClients.CustomerManagement.Models.RegisterCustomerRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::EcommerceDDD.ServiceClients.CustomerManagement.Models.RegisterCustomerRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::EcommerceDDD.ServiceClients.CustomerManagement.Models.RegisterCustomerRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.CustomersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.CustomersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::EcommerceDDD.ServiceClients.CustomerManagement.Api.V2.Customers.CustomersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
