...
#nullable enable
        public async Task<Stream?> PostAsync(global::EcommerceDDD.ServiceClients.CustomerManagement.Models.RegisterCustomerRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PostAsync(global::EcommerceDDD.ServiceClients.CustomerManagement.Models.RegisterCustomerRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
