...
#nullable enable
        public async Task<string?> PostAsync(global::EcommerceDDD.ServiceClients.ShipmentProcessing.Models.ShipOrderRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<string> PostAsync(global::EcommerceDDD.ServiceClients.ShipmentProcessing.Models.ShipOrderRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
