...
using System;
namespace EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Internal.Inventory.CheckStockQuantity
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v2\internal\inventory\check-stock-quantity
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class CheckStockQuantityRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Internal.Inventory.CheckStockQuantity.CheckStockQuantityRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CheckStockQuantityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v2/internal/inventory/check-stock-quantity", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Internal.Inventory.CheckStockQuantity.CheckStockQuantityRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CheckStockQuantityRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v2/internal/inventory/check-stock-quantity", rawUrl)
        {
        }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::EcommerceDDD.ServiceClients.InventoryManagement.Models.CheckProductsInStockRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::EcommerceDDD.ServiceClients.InventoryManagement.Models.CheckProductsInStockRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Internal.Inventory.CheckStockQuantity.CheckStockQuantityRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Internal.Inventory.CheckStockQuantity.CheckStockQuantityRequestBuilder WithUrl(string rawUrl)
        {
            return new global::EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Internal.Inventory.CheckStockQuantity.CheckStockQuantityRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
