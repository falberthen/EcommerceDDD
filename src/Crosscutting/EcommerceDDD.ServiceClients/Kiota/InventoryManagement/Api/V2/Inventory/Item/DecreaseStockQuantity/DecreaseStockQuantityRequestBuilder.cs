...
using System;
namespace EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Inventory.Item.DecreaseStockQuantity
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v2\inventory\{productId}\decrease-stock-quantity
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class DecreaseStockQuantityRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Inventory.Item.DecreaseStockQuantity.DecreaseStockQuantityRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DecreaseStockQuantityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v2/inventory/{productId}/decrease-stock-quantity", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Inventory.Item.DecreaseStockQuantity.DecreaseStockQuantityRequestBuilder"/> and sets the default values.
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Inventory.Item.DecreaseStockQuantity.DecreaseStockQuantityRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Inventory.Item.DecreaseStockQuantity.DecreaseStockQuantityRequestBuilder WithUrl(string rawUrl)
        {
            return new global::EcommerceDDD.ServiceClients.InventoryManagement.Api.V2.Inventory.Item.DecreaseStockQuantity.DecreaseStockQuantityRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
