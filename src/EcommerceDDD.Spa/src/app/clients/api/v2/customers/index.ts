...
// @ts-ignore
import { createProblemDetailsFromDiscriminatorValue, serializeRegisterCustomerRequest, type ProblemDetails, type RegisterCustomerRequest } from '../../../models/index.js';
// @ts-ignore
...
// @ts-ignore
import { type WithCustomerItemRequestBuilder, WithCustomerItemRequestBuilderNavigationMetadata } from './item/index.js';
// @ts-ignore
...
export interface CustomersRequestBuilder extends BaseRequestBuilder<CustomersRequestBuilder> {
    ...
    /**
     * Gets an item from the ApiSdk.api.v2.customers.item collection
 ...
 */
export const CustomersRequestBuilderUriTemplate = "{+baseurl}/api/v2/customers";
/**
