...
// @ts-ignore
import { createOrderViewModelIListApiResponseFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, type OrderViewModelIListApiResponse, type ProblemDetails } from '../../../models/index.js';
// @ts-ignore
...
export interface OrdersRequestBuilder extends BaseRequestBuilder<OrdersRequestBuilder> {
    ...
    /**
     * Gets an item from the ApiSdk.api.v2.orders.item collection
 ...
 */
export const OrdersRequestBuilderUriTemplate = "{+baseurl}/api/v2/orders";
/**
