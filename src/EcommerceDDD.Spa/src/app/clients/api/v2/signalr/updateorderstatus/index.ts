...
// @ts-ignore
import { createProblemDetailsFromDiscriminatorValue, serializeUpdateOrderStatusRequest, type ProblemDetails, type UpdateOrderStatusRequest } from '../../../../models/index.js';
// @ts-ignore
